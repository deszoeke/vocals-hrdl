function filter_epsilon(epsilon, F ,spec, ulev, relerreps, count)
# [epsfilled, epszint, epszsmooth] = filter_epsilon(epsilon, spec, ulev, relerreps, count)
# Fill & filter TKE dissipation rate [epsilon] time series.
...
## constants
crosscomp  = 3 / 4
kolmogorov = 0.54; # Matches atmospheric boundary layer estimates & Sreenivasan 1995
...
## vertically smooth
epy = runningnanmean2(epx, 3, 1, 2, 3); 
return epsfilled, epx, epy
end
