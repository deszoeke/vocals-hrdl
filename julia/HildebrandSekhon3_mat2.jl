function HildebrandSekhon3(S,z1side)
# [sthr,meannoise,kthr]=HildebrandSehkon[F,S]
# White noise threshold and mean finder modified from [Hildebrand & Sekhon 1974] 
...
# My method includes lower & lower frequency spectral estimates until one can be
...
# is normal & testing for when spectral estimates below a wavenumber
...
# P; Q are mean & var of the distribution; s is its lowest-wavenumber realization
...
# +1 bc we tested for the last that failed; & +1 bc t is advanced 1
...
# noise from k^-5/3 turbulence. It cuts off too much turbulence; & sets
